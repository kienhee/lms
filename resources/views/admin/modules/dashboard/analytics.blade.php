    ...
    <section id="analytics">
        <div class="card  my-4">
            ...
            <div class="card-body row">
                <div class="d-flex align-items-end row mb-5 col-12 ">
                    <div class="col-sm-7">
                        <div class="card-body">
                    ...
                    <div class="col-sm-5 text-end text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                            <img src="{{ asset_admin_url('assets/img/illustrations/man-with-laptop-light.png') }}"
                    ...
                    <div class="card-body">
                        <div class="bg-label-primary rounded-3 text-center mb-3 pt-4">
                            <img class="img-fluid w-60"
                                src="{{ asset_admin_url('assets/img/illustrations/sitting-girl-with-laptop-dark.png') }}"
                                alt="Card girl image" />
                        </div>
...
@push('scripts')
    ...
    @vite(['resources/js/admin/pages/academy/dashboard.js'])
@endpush
