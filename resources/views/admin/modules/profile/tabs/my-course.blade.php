@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset_admin_url('assets/vendor/libs/plyr/plyr.css') }}">
    <link rel="stylesheet" href="{{ asset_admin_url('assets/vendor/css/pages/app-academy.css') }}">
@endpush
<div class="tab-pane fade" id="my-course-tab" role="tabpanel">
    <div class="app-academy">
        <div class="card p-0 mb-4">
            <div class="card-body d-flex flex-column flex-md-row justify-content-between p-0 pt-4">
                <div class="app-academy-md-25 card-body py-0">
                    <img src="{{ asset_admin_url('assets/img/illustrations/bulb-light.png') }}"
                ...
                <div class="app-academy-md-25 d-flex align-items-end justify-content-end">
                    <img src="{{ asset_admin_url('assets/img/illustrations/pencil-rocket.png') }}" alt="pencil rocket"
                ...
                <div class="row gy-4 mb-4">
                        ...
                        <div class="card p-2 h-100 shadow-none border">
                            <div class="rounded-2 text-center mb-3">
                                <a href="app-academy-course-details.html"><img class="img-fluid"
                                        src="{{ asset_admin_url('assets/img/pages/app-academy-tutor-1.png') }}"
                                        alt="tutor image 1" /></a>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card p-2 h-100 shadow-none border">
                            <div class="rounded-2 text-center mb-3">
                                <a href="app-academy-course-details.html"><img class="img-fluid"
                                        src="{{ asset_admin_url('assets/img/pages/app-academy-tutor-2.png') }}"
                                        alt="tutor image 2" /></a>
                            </div>
                            <div class="card-body p-3 pt-2">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card p-2 h-100 shadow-none border">
                            <div class="rounded-2 text-center mb-3">
                                <a href="app-academy-course-details.html"><img class="img-fluid"
                                        src="{{ asset_admin_url('assets/img/pages/app-academy-tutor-3.png') }}"
                                        alt="tutor image 3" /></a>
                            </div>
                            <div class="card-body p-3 pt-2">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card p-2 h-100 shadow-none border">
                            <div class="rounded-2 text-center mb-3">
                                <a href="app-academy-course-details.html"><img class="img-fluid"
                                        src="{{ asset_admin_url('assets/img/pages/app-academy-tutor-4.png') }}"
                                        alt="tutor image 4" /></a>
                            </div>
                            <div class="card-body p-3 pt-2">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <h6 class="d-flex align-items-center justify-content-center gap-1 mb-0">
                                        3.8 <span class="text-warning"><i class="bx bxs-star me-1"></i></span><span
                                ...
                                <p class="d-flex align-items-center"><i class="bx bx-time-five me-2"></i>30 minutes
                                </p>
                                <div class="progress mb-4" style="height: 8px">
                                    <div class="progress-bar w-75" role="progressbar" aria-valuenow="25"
                                        aria-valuemin="0" aria-valuemax="100"></div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card p-2 h-100 shadow-none border">
                            <div class="rounded-2 text-center mb-3">
                                <a href="app-academy-course-details.html"><img class="img-fluid"
                                        src="{{ asset_admin_url('assets/img/pages/app-academy-tutor-5.png') }}"
                                        alt="tutor image 5" /></a>
                            </div>
                            <div class="card-body p-3 pt-2">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <h6 class="d-flex align-items-center justify-content-center gap-1 mb-0">
                                        4.7 <span class="text-warning"><i class="bx bxs-star me-1"></i></span><span
                                ...
                                <a class="w-100 btn btn-label-primary" href="app-academy-course-details.html"><i
                                        class="bx bx-sync me-2"></i>Start Over</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="card p-2 h-100 shadow-none border">
                            <div class="rounded-2 text-center mb-3">
                                <a href="app-academy-course-details.html"><img class="img-fluid"
                                        src="{{ asset_admin_url('assets/img/pages/app-academy-tutor-6.png') }}"
                                        alt="tutor image 6" /></a>
                            </div>
                            <div class="card-body p-3 pt-2">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="badge bg-label-danger">UI/UX</span>
                                    <h6 class="d-flex align-items-center justify-content-center gap-1 mb-0">
                                        3.6 <span class="text-warning"><i class="bx bxs-star me-1"></i></span><span
                    ...
                    <div class="card-body d-flex justify-content-between flex-wrap-reverse">
                        ...
                        <div
                            ...
                            <img class="img-fluid scaleX-n1-rtl"
                                src="{{ asset_admin_url('assets/img/illustrations/boy-app-academy.png') }}"
                ...
                <div class="card bg-label-danger h-100">
                    <div class="card-body d-flex justify-content-between flex-wrap-reverse">
                        ...
                        <div
                            class="w-100 app-academy-sm-40 d-flex justify-content-center justify-content-sm-end h-px-150 mb-3 mb-sm-0">
                            <img class="img-fluid scaleX-n1-rtl"
                                src="{{ asset_admin_url('assets/img/illustrations/girl-app-academy.png') }}"
...
@push('scripts')
    ...
    <script src="{{ asset_admin_url('assets/vendor/libs/plyr/plyr.js') }}"></script>
    @vite(['resources/js/admin/pages/academy/course.js'])
@endpush
